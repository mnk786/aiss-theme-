...
if ( is_archive() ) {
	$post_type = get_post_type();
       $hclass = '';
	if ( $post_type == 'question_answer' ) {
		$hclass = 'inner-page-head';
	}

}

if ( is_category()  || is_single() || is_page() || is_tax('service_category')) {

		$hclass = 'inner-page-head-two';
}
//exit;
?>
